...
namespace NumberConverter
{
  ...
  class Converter
  {
    ...
    private Int16 radix;
    private char signOfConvertibleNumber = '+';
    ...
    public Converter(string numberToConvert, string basisForConverting)
    {
      ...
      if (radix < 2 || radix > 20 || convertibleNumber.Equals(0))
      {
        throw new ConvertingException();
      }
      if (convertibleNumber < 0)
      {
        signOfConvertibleNumber = '-';
      }
    }
    ...
    public char[] ConvertNumberToSelectedNumeralSystem(string chosenNumeralSystem)
    {
      ...
      if (signOfConvertibleNumber.Equals('-'))
      {
        convertedNumber.Append(signOfConvertibleNumber);
      }
      char[] outputArray = convertedNumber.ToString().ToCharArray();
